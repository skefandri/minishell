...
SRC_MAN = minishell.c get_cmd_file.c utils_main.c ./utils/ft_split.c ./utils/ft_strdup.c ./src/lexer.c ./src/syntax_error.c \
		...
		utils/arr_dup.c utils/tab_size.c ./src/expand.c ./src/utils_expand.c ./builtins/exit.c ./builtins/unset.c \
...
CFLAGS = -Wextra -Werror -Wall -lreadline -lncurses -L /Users/ysabr/Desktop/readline-8.2 -I /Users/ysabr/Desktop/readline-8.2  #-fsanitize=address  -g3
all : $(NAME)
$(NAME) : $(SRC_MAN)
		stty -echoctl
